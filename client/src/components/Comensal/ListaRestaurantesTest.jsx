        ...
        <List
            ...
            renderItem={item => (
                ...
                >
                    <List.Item.Meta
                        avatar={<Avatar
                            src="https://www.flaticon.com/svg/vstatic/svg/2921/2921822.svg?token=exp=1617860342~hmac=11b28e9fe4fb75d686290f069b8af2ef"/>}
                        title={<a>Restaurante: {item.nombres}</a>}
