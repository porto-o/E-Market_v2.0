...
import {deleteAccountComensalApi, changeNameComensalApi, changePasswordComensalApi} from "../../api/ComensalApi";
    ...
    return(
      <Button href="">
          <Grid container spacing={3} direction="row">
            <Grid item xs={6}>
                <Avatar src="https://porfirios.com.mx/blog/wp-content/uploads/2019/03/Apertura-TOREO-blog-604x270.png">
                </Avatar>
            </Grid>
          <Grid item xs={6}>
    ...
    return (
        <Button href="/comensal">
            <Card
                hoverable
                cover={
                    <img alt="Mi Lista" src="https://image.freepik.com/free-vector/people-healthy-food_24908-55176.jpg"/>
                }
            >
                <Meta title="Mi Lista"/>
            </Card>
...
export function MetodosPago() {
    ...
    const mensaje = () => {
        Modal.info({
            ...
            content: (
                <div>
                    <p>Actualmente solo estamos aceptado pagos por tarjeta de crédito. Dentro de poco podrás almacenar tus métodos de pago.</p>
                </div>
            ),
            onOk() {},
        });
