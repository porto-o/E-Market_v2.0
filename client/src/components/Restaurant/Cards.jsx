...
export function HistorialP() {
  ...
  const envioDatos = ()=> {
    ...
    window.location = `/restaurante/history/${nombreRes}`
  }
  return (
    <Button onClick={envioDatos}>
      <Card
        hoverable
        cover={
          <img
      ...
      <CardContent>
        ...
        >
                        ...
                        rules={[
                          {
                            required: true,
                            message:
                              "¡Porfavor ingresa el nombre del administrador!",
                          },
                        ]}
                      >
                        <Input />
          ...
          <div onSubmit={deleteAccount}>
            <form action="/deleteAccountRestaurant" method="POST" noValidate>
