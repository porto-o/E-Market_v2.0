...
export default function RecordOrders() {
  ...
  return (
    <div className={classes.root}>
      <Typography variant="h4">Ordenes en progreso</Typography>
            ...
            {stateOrdenes.map((item) => (
              ...
              <TableRow className={classes.row}>
                ...
                <TableCell align="right">
                  ...
                  >
                    <Option value={"0"} id={item.id}>
                      Recibido en Cocina
                    </Option>
                    <Option value="1" id={item.id}>
                      Cocinando
                    </Option>
                    <Option value="2" id={item.id}>
                      Entregada
                    </Option>
                  </Select>
                </TableCell>
      ...
      <Grid>
        <label>
          <Typography variant="h5">Número de Ordenes</Typography>
        </label>
        <br></br>
        <Box component="span">
          <Typography variant="h4">{stateOrdenes.length}</Typography>
        </Box>
      </Grid>
    </div>
  );
